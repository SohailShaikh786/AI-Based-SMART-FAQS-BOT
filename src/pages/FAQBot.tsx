...
import { Loader2, Send, Bot, User, FileText, Info, Mic, MicOff, AlertCircle } from 'lucide-react';
...
export default function FAQBot() {
  ...
  // Voice recorder — append final transcript to the input field
  ...
  } = useVoiceRecorder({ onTranscript: handleVoiceTranscript });
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-2">
              ...
              {interimTranscript && (
                <div className="text-xs text-muted-foreground italic px-1 flex items-center gap-1.5">
                  ...
                  <span>Hearing: &ldquo;{interimTranscript}&rdquo;</span>
                </div>
              )}
              ...
              <div className="flex gap-2">
                ...
                {/* Mic button — only shown when browser supports SpeechRecognition */}
                {voiceSupported && (
                  <Button
                    type="button"
                    ...
                    className={`relative ${
                      isListening
                        ? 'ring-2 ring-red-500 ring-offset-1 after:absolute after:inset-0 after:rounded-md after:animate-ping after:bg-red-400/30'
                        : ''
                    }`}
                  >
                    {isListening ? (
